local vehshop = {
	...
	menu = {
		...
		["vehicles"] = { 
			...
			name = "vehicles",
			buttons = { 
				{name = "Compacts", description = 'Because you couldn't afford to buy a real car'},
				{name = "Coupes", description = ''},
				{name = "Sedans", description = ''},
				{name = "Sports", description = 'For all your mid-life crisis needs'},
				{name = "Sports Classics", description = 'You wanted a sport car, but then you remembered you were a hipster'},
				...
				{name = "Added Cars", description = 'WIP'},
		...
		["compacts"] = { 
			...
			name = "compacts",
			buttons = { 
				{name = "Dinka Blista", costs = 15000, description = {}, model = "blista"},
				{name = "Grotti Brioso R/A", costs = 155000, description = {}, model = "brioso"},
				{name = "Karin Dilettante", costs = 25000, description = {}, model = "Dilettante"},
				{name = "Weeny Issi", costs = 18000, description = {}, model = "issi2"},
				{name = "Benefactor Panto", costs = 85000, description = {A car you buy when you want to brag to your friends that you have a Benefactor, but really, you only have a Panto.}, model = "panto"},
		...
		["sportsclassics"] = { 
			...
			buttons = { 
				...
				{name = "JB 700", costs = 350000, description = {}, model = "jb7002"},
		...
		["sedans"] = { 
			...
			name = "Added Cars",
			buttons = { 
				{name = "Admiral", costs = 0, description = {}, model = "admiral"},
				{name = "Bobcat", costs = 0, description = {}, model = "asterope"},
				--{name = "Bodhi", costs = 0, description = {}, model = "bodhi"},
				--{name = "brickade2", costs = 0, description = {}, model = "brickade2"},
				--{name = "buccaneer3", costs = 0, description = {}, model = "buccaneer3"},
				--{name = "chavos", costs = 0, description = {}, model = "chavos"},
				{name = "cheetah2", costs = 0, description = {}, model = "cheetah2"},
				{name = "coquette4", costs = 0, description = {}, model = "coquette4"},
				{name = "df8", costs = 0, description = {}, model = "df8"},
				{name = "esperanto", costs = 0, description = {}, model = "esperanto"},
				{name = "feltzer", costs = 0, description = {}, model = "feltzer"},
				{name = "feroci", costs = 0, description = {}, model = "feroci"},
				{name = "fortune", costs = 0, description = {}, model = "fortune"},
				{name = "Regina", costs = 0, description = {}, model = "regina"},
				{name = "Futo Hatch", costs = 0, description = {}, model = "futo2"},
				{name = "fxt", costs = 0, description = {}, model = "fxt"},
				{name = "Stratum", costs = 0, description = {}, model = "stratum2"},
				{name = "huntley2", costs = 0, description = {}, model = "huntley2"},
				{name = "interceptor", costs = 0, description = {}, model = "interceptor"},
				{name = "phoenix2", costs = 0, description = {}, model = "phoenix2"},
				{name = "pmp600", costs = 0, description = {}, model = "pmp600"},
				{name = "pres2", costs = 0, description = {}, model = "pres2"},
				{name = "rancher", costs = 0, description = {}, model = "rancher"},
				{name = "rebla", costs = 0, description = {}, model = "rebla"},
				{name = "rom", costs = 0, description = {}, model = "rom"},
				{name = "sabre", costs = 0, description = {}, model = "sabre"},
				{name = "schafter", costs = 0, description = {}, model = "schafter"},
				{name = "sentinel3", costs = 0, description = {}, model = "sentinel3"},
				{name = "sultan2", costs = 0, description = {}, model = "sultan2"},
				{name = "supergt", costs = 0, description = {}, model = "supergt"},
				{name = "turismo3", costs = 0, description = {}, model = "turismo3"},
				{name = "typhoon", costs = 0, description = {}, model = "typhoon"},
				{name = "uranus", costs = 0, description = {}, model = "uranus"},
				{name = "vincent", costs = 0, description = {}, model = "vincent"},
				{name = "willard", costs = 0, description = {}, model = "willard"},
				{name = "comet retro", costs = 0, description = {}, model = "comet4"},
				{name = "Comet", costs = 0, description = {}, model = "comet6"},
				{name = "Race Elegy", costs = 0, description = {}, model = "r35"},
				{name = "Gauntlet C", costs = 0, description = {}, model = "gauntlet3"},
			}
		},
			...
			for i,button in pairs(menu.buttons) do
				if i >= vehshop.menu.from and i <= vehshop.menu.to then
					...
					if button.costs ~= nil then
						if vehshop.currentmenu == "compacts" or vehshop.currentmenu == "coupes" or vehshop.currentmenu == "sedans" or vehshop.currentmenu == "Added Cars" or vehshop.currentmenu == "sports" or vehshop.currentmenu == "sportsclassics" or vehshop.currentmenu == "super" or vehshop.currentmenu == "muscle" or vehshop.currentmenu == "offroad" or vehshop.currentmenu == "suvs" or vehshop.currentmenu == "vans" or vehshop.currentmenu == "industrial" or vehshop.currentmenu == "cycles" or vehshop.currentmenu == "motorcycles" then
					...
					y = y + 0.04
					if vehshop.currentmenu == "compacts" or vehshop.currentmenu == "coupes" or vehshop.currentmenu == "sedans" or vehshop.currentmenu == "sports" or vehshop.currentmenu == "Added Cars" or vehshop.currentmenu == "sportsclassics" or vehshop.currentmenu == "super" or vehshop.currentmenu == "muscle" or vehshop.currentmenu == "offroad" or vehshop.currentmenu == "suvs" or vehshop.currentmenu == "vans" or vehshop.currentmenu == "industrial" or vehshop.currentmenu == "cycles" or vehshop.currentmenu == "motorcycles" then
						if selected then
...
function ButtonSelected(button)
	...
	elseif this == "compacts" or this == "coupes" or this == "sedans" or this == "Added Cars" or this == "sports" or this == "sportsclassics" or this == "super" or this == "muscle" or this == "offroad" or this == "suvs" or this == "vans" or this == "industrial" or this == "cycles" or this == "motorcycles" then
